...
import Header from '../components/AMA/Header/Component';
import HeaderLogo from '../components/AMA/Header/Logo';
import HeaderDarkButtonContainer from '../components/AMA/Header/DarkButton/Container';
import HeaderUsername from '../components/AMA/Header/Username';
